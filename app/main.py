...
def add_sidebar():
    ...
    slider_labels = [
        ...
        ("Concave points (mean)", "concave_points_mean"),  # fixed
        ...
        ("Concave points (se)", "concave_points_se"),  # fixed
        ...
        ("Concave points (worst)", "concave_points_worst"),  # fixed
...
def get_scaled_values(input_dict):
    ...
    for key, value in input_dict.items():
        max_value = X[key].max()
        min_value = X[key].min()   # ✅ fixed
        scaled_value = (value - min_value) / (max_value - min_value)
        scaled_dict[key] = scaled_value

    return scaled_dict   # ✅ moved outside loop
...
def add_predictions(input_data):
    ...
    st.write("Prbobability of being Benign: ", model.predict_proba(input_array_scaled)[0][0])
    st.write("Prbobability of being Malicious: ", model.predict_proba(input_array_scaled)[0][1])
