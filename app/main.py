...
def get_radar_chart(input_data):
    ...
    fig.add_trace(go.Scatterpolar(
        ...
        theta=categories, fill='toself', name='Mean Value'
    ))
    ...
    fig.add_trace(go.Scatterpolar(
        ...
        theta=categories, fill='toself', name='Standard Error'
    ))
    ...
    fig.add_trace(go.Scatterpolar(
        ...
        theta=categories, fill='toself', name='Worst Value'
    ))
